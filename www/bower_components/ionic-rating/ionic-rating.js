...
(function() {
  angular.module('ionic.rating', []).constant('ratingConfig', {
    ...
    return {
      ...
      template: '<ul class="rating" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon" ng-class="value === undefined ? (r === 1 ? \'ion-android-star\' : (r === 2 ? \'ion-android-star-half\' : \'ion-android-star-outline\')) : (value > $index ? (value < $index+1 ? \'ion-android-star-half\' : \'ion-android-star\') : \'ion-android-star-outline\')"></i></li>' + '</ul>',
      replace: true,
